function [SysParam] = Parameter_Test_SiO2()

%% DATA FILE NAME
%sio2 test N2
SysParam.filename = 'sio2_N2_test_SHIFTED.mat';
%% SAMPLE PROPERTIES (starting with top layer )
SysParam.Lambda  = [237  1.3 124];  % Thermal conductivities (W m^-1 K^-1)
SysParam.C       = [2.4 1.86 1.63]*1e6;  % Volumetric heat capacities (J m^-3 K^-1)
SysParam.h       = [65 1040 1e6]*1e-9;  % Thicknesses (m)  %67nm Al 
