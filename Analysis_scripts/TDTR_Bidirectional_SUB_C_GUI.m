...
function [Z,Ratio_model] = TDTR_Bidirectional_SUB_C(X,Ratio_data,tdelay,tau_rep,f,Lambda,C,h,eta,r_pump,r_probe,P_pump,nnodes,FITNLambda,FITNC,FITNh,X_heat,X_temp,AbsProf,plotaxis)
...
semilogx(plotaxis,tdelay,Ratio_data,'ob',tdelay,Ratio_model,'g'); 
axis(plotaxis,[100e-12 10e-9 0 max([Ratio_data;Ratio_model])])
drawnow;
pause(0.01)