% Parameter file for Al/Si (no interface in between)

function [SysParam] = step1_tutorial() %Apr19Fits_Si_025nmSiO2_2MHz() %This is a test file

%% DATA FILE NAME

SysParam.filename = 'dataForFits\Si_2MHz_180423_130021_FIN_NoNaNs.mat';
...
SysParam.C       = [2.42 1.63]*1e6;  % Volumetric heat capacities (J m^-3 K^-1)
SysParam.h       = [80 1e6]*1e-9;  % Thicknesses (m)  
