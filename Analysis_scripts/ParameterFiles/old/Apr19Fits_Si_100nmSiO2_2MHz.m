function [SysParam] = Apr19Fits_Si_100nmSiO2_2MHz()
...
% Multiple files:
SysParam.filename = 'dataForFits\Si_100nmSiO2_2MHz_180423_180256_FIN_NoNaNs.mat';
% <<<<
...
SysParam.Lambda  = [237 0.129 1.04 999 124];  % Thermal conductivities (W m^-1 K^-1)
SysParam.C       = [2.42 2.42 1.86 2.42 1.63]*1e6;  % Volumetric heat capacities (J m^-3 K^-1)
SysParam.h       = [77.3365 1 100 1 1e6]*1e-9;  % Thicknesses (m)  
