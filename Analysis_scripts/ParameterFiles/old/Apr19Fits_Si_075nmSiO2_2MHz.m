function [SysParam] = Apr19Fits_Si_075nmSiO2_2MHz()

%% DATA FILE NAME

SysParam.filename = 'dataForFits\Si_075nmSiO2_2MHz_180423_173212_FIN_NoNaNs.mat';
...
SysParam.Lambda  = [237 0.129 0.966 999 124];  % Thermal conductivities (W m^-1 K^-1)
SysParam.C       = [2.42 2.42 1.86 2.42 1.63]*1e6;  % Volumetric heat capacities (J m^-3 K^-1)
SysParam.h       = [77.3365 1 68.5 1 1e6]*1e-9;  % Thicknesses (m)  
