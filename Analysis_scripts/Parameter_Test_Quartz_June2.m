function [SysParam] = Parameter_Test_Quartz_June2()


%% DATA FILE NAME
SysParam.filename = 'Quartz_N4_June2_prep_SHIFTED.mat';
%% SAMPLE PROPERTIES (starting with top layer )
SysParam.Lambda  = [237 0.3 1.4];  % Thermal conductivities (W m^-1 K^-1)
SysParam.C       = [2.4 0.1 1.88]*1e6;  % Volumetric heat capacities (J m^-3 K^-1)
SysParam.h       = [80 1 1e6]*1e-9;  % Thicknesses (m)   
