...
%% USER INPUT
    [SysParam] = curr_Nov07_2MHz_CuI_80deg_pt1(); %Parameter_Example(); %load parameters (matlab function, parameters are assigned in next section below)
...
%% THIS PART HAS BEEN UPDATED BY VIHTORI.
% Commenting out all the unnecessary parts below,
% and adding the new material...  >>>>>
