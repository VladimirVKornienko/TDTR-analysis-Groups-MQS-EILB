function [SysParam] = Parameter_Test_Si_June2()


%% DATA FILE NAME
SysParam.filename = 'Si_N3_June2_prep_SHIFTED.mat';
%% SAMPLE PROPERTIES (starting with top layer )
SysParam.Lambda  = [45 0.3 124];  % Thermal conductivities (W m^-1 K^-1)
SysParam.C       = [2.9 0.1 1.63]*1e6;  % Volumetric heat capacities (J m^-3 K^-1)
SysParam.h       = [75 1 1e6]*1e-9;  % Thicknesses (m)   
